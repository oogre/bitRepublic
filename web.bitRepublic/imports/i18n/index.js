...
i18n.addTranslation('en-US', "Menu", "genereate", "Generate your wallet");
...
i18n.addTranslation('en-US', "Menu", "technicalSupport", "Technical Support");
i18n.addTranslation('en-US', "Menu", "translation", "Translation");
i18n.addTranslation('en-US', "Menu", "LowTechLab", "Low Tech Lab");
...
i18n.addTranslation('en-US', "Menu", "Awesome", "Awesome!");
i18n.addTranslation('en-US', "Menu", "confirm", "confirm");
...
i18n.addTranslation('en-US', "Installation", "info", "B", "desciption", "A", "The BitSoil Tax & Hack Campaign is directly connected with bitREPUBLIC - an offline artwork which currently is being exhibited at SongEun ArtSpace in Seoul.");
...
i18n.addTranslation('en-US', "WhoWeAre", "C", "The Bitsoiltax campaign grew out of shared ideas on growth and wealth in the data economy, on social justice and tax abuse, on tackling net giants on tax evasion. The bitsoil tax can be thought of as a hacktivist act. For this project we worked essentially with programmers. Thanks to Jenny Mainframe,  <a href=\"http://ogre.be/\" target=\"_blank\">Vincent Evrard</a>, <a href=\"http://crucifixarnaud.com/\" target=\"_blank\">Arnaud Crucifix</a>, Fleur Wirtz and the Peng! collective. Special thanks to <a href=\"https://imal.org/\" target=\"_blank\">iMAL</a> for the continuous support of the project since its very beginning. <p>For the Wuhan version of the installation, special thanks to Simon Fang, Founder of Big House Contemporary Art Center, Genie Huang Project Manager of BHCAC, Project Assistant Fugui Zheng and the China University of Geosciences for the tremendous work they did during the making off of the installation.</p>");
