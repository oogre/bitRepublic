...
i18n.addTranslation('en-US', "WhoWeAre", "C", "The Bitsoiltax campaign grew out of shared ideas on growth and wealth in the data economy, on social justice and tax abuse, on tackling net giants on tax evasion. The bitsoil tax can be thought of as a hacktivist act. For this project we worked essentially with programmers. Thanks to Jenny Mainframe, <a href=\"http://ogre.be/\" target=\"_blank\">Vincent Evrard</a>, <a href=\"http://crucifixarnaud.com/\" target=\"_blank\">Arnaud Crucifix</a>, Fleur Wirtz and the Peng! collective. Special thanks to <a href=\"https://imal.org/\" target=\"_blank\">iMAL</a> for the continuous support of the project since its very beginning. For the Wuhan version, special thanks to Simon Fang, Founder of Big HouseContemporary Art Center方维 Big House当代艺术中心创始人, Genie Huang 黄晶晶 项目经理 Project Manager of BHCAC, Great Zheng 郑富贵项目助 Project Assistance of BHCAC and the China University of Geosciences. Geosciences. ");
