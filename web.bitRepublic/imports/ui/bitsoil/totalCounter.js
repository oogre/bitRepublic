/*----------------------------------------*\
  ...
  @Last Modified time: 2018-08-28 21:33:42
\*----------------------------------------*/
						...
						<div>
							<div className="counter--xl">
								<button onMouseEnter={this.toggleHover.bind(this, true, 0)} onMouseLeave={this.toggleHover.bind(this, false, 0)} className="button--unstyled counter__prefix" onClick={this.handleInfo.bind(this, 0)}>
									...
									<svg className={(this.state.hover[0] ? "": "invisible" )+" over artwork-bitsoil-symbol artwork-info-symbol"} width="98" height="98" viewBox="0 0 7 31" xmlns="http://www.w3.org/2000/svg"><title>icon-info</title><g fill="#F1F5F8" fillRule="evenodd"><path d="M0 0h7v7H0zM0 13h7v18H0z"></path></g></svg>
								</button>
							...
							<div className="counter--xl">
								<button onMouseEnter={this.toggleHover.bind(this, true, 1)} onMouseLeave={this.toggleHover.bind(this, false, 1)} className="button--unstyled counter__prefix" onClick={this.handleInfo.bind(this, 1)}>
									...
									<svg className={(this.state.hover[1] ? "": "invisible" )+" over artwork-bitsoil-symbol artwork-info-symbol"} width="98" height="98" viewBox="0 0 7 31" xmlns="http://www.w3.org/2000/svg"><title>icon-info</title><g fill="#F1F5F8" fillRule="evenodd"><path d="M0 0h7v7H0zM0 13h7v18H0z"></path></g></svg>
								</button>
