					...
					this.props.isReady ?
						<div>
							<div className="counter--xl">
								<div className="counter__prefix" onClick={this.handleInfo.bind(this)}>
							...
							<div className="counter--xl">
								<img className="artwork-tax-logo" src="/images/hand-purse-animated-with-bg.gif" alt="" onClick={this.handleInfo.bind(this)}/>
