						...
						<div className="column">
							...
							<div className="column__content">
								...
								<ul className="menu menu--footer">
									...
									<li className="menu__item">
										<a className="menu__item__link" href="http://larbitslab.be">larbitslab.be</a>
									</li>
								</ul>
							</div>
						</div>
