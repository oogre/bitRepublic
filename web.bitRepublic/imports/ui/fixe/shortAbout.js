/*----------------------------------------*\
  ...
  @Last Modified time: 2018-04-26 18:03:22
\*----------------------------------------*/
			...
			<div id="shortAbout" className="short-about">
				<div className="container">
					<div className="short-about__col">
						...
						<p className="short-about__content">On the bitsoil website, participants can create their own troupe of tax collector bots tailored with a set of predefined tax claims and send them to leaders and influencers of this world as for instance to the CEO’s of the top 10 biggest tech giants or to the Prime Minister of his choice.</p>
					</div>
					<div className="short-about__col">
